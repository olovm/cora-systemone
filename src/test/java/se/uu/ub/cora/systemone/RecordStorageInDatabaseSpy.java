...
public class RecordStorageInDatabaseSpy implements RecordStorage, MetadataStorage, SearchStorage {

	private SqlConnectionProvider connectionProvider;

	public static RecordStorageInDatabaseSpy createRecordStorageInDatabaseUsingConnectionProvider(
			SqlConnectionProvider connectionProvider) {
		return new RecordStorageInDatabaseSpy(connectionProvider);
	}

	private RecordStorageInDatabaseSpy(SqlConnectionProvider connectionProvider) {
